  ...
  return (
    <div className="bg-gray-200 h-screen">
        ...
        <main className='md:max-w-7xl mx-auto sm:px-16 align-middle mt-5 bg-white rounded-sm shadow-sm p-5 h-[50%]'>
            <h1 className='text-red-500 text-9xl text-center font-extrabold'>ERROR</h1>
            <h1 className='text-gray-500 text-center font-bold'>There was an unexpected error while fetching your data</h1>
