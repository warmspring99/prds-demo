                ...
                <>
                    <section className='pt-6 border-b-2 mb-3 pb-3 flex justify-between'>
                        ...
                        <div className='justify-end flex col-start-4'>
                            ...
                            onClick={addProperty}><PlusIcon className='w-5 h-5'/></button>
                        </div>
                    </section>
                    <section className='mx-auto flex justify-center'>
                        ...
                        <tr key={'id'}>
                            ...
                            <Tr label='Categories'/>
                            <Tr label='Region' sortable/>
                            <Tr label='Owner' sortable/>
                            <Tr label='Guests' sortable/>
                            <Tr label='More Info' />
                        </tr>
                        }
                        ...
                        <tr className='border-collapse' key={row.id}>
                            ...
                            <td className='dataTableColumn'>{row.categories}</td>
                            <td className='dataTableColumn'>{row.region}</td>
                            <td className='dataTableColumn'>{row.owner}</td>
                            <td className='dataTableColumn'>{row.guests}</td>
                            <td className='dataTableColumn'>
